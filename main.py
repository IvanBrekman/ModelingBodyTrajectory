...
class AboutWindow(QWidget):
    def __init__(self):
        super().__init__()
        uic.loadUi(f'{DATA_DIR}/ui_files/about_wnd.ui', self)
...
class SettingsWindow(QWidget):
    ...
    def initUI(self):
        uic.loadUi(f'{DATA_DIR}/ui_files/settings_wnd.ui', self)
...
class AboutShotWindow(QWidget):
    """ Класс окна с информацией о броске """

    def __init__(self, info: dict, moment_pos=None):
        super().__init__()

        self.info = {key: value for key, value in info.items()}
        self.info.pop(y0)
    ...
    def initUI(self):
        uic.loadUi(f'{DATA_DIR}/ui_files/about_shot_wnd.ui', self)
...
class SaveShotWindow(QWidget):
    ...
    def initUI(self):
        uic.loadUi(f'{DATA_DIR}/ui_files/save_results.ui', self)
    ...
    def save(self):
        ...
        # Проверка на пустое название эксперимента
...
class MainWindow(QMainWindow):
    ...
    @staticmethod
    def open_web_page():
        """ Метод открывает ссылку на информационный ресурс """
    ...
    def load_experiment(self):
        ...
        self.load_from_file(info_file)

        self.build_btn.click()
        self.tabWidget.setCurrentIndex(0)

    def load_exp_table(self):
        names = [res[1] for res in get_data_from_db(MY_DB, 'results', '*')]
    ...
    def delete_experiment(self):
        ...
        delete_data_from_db(MY_DB, 'results', {'name': [delete_name]})
    #
